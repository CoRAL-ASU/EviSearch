...
- **API keys:** From `.env`: `GEMINI_API_KEY`, `OPENAI_API_KEY`, `NOVITA_API_KEY`, `LLAMA_KEY` (Groq), `DEEPINFRA_API_KEY`; optional GCP/Vertex: `GCP_PROJECT_ID`, `GCP_LOCATION`.
...
API keys (from `.env`): `GEMINI_API_KEY`, `OPENAI_API_KEY`, `NOVITA_API_KEY`, `LLAMA_KEY`, `DEEPINFRA_API_KEY`.
